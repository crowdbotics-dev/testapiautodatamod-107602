...
## Project Structure
    ...
    ├── testapiautodatamod_107602  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_107602`
...
2. Clone this repo and `cd testapiautodatamod_107602`
